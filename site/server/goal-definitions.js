...
const nodes = [
  ...
  },
  {
    ...
    type: "activity",
    description:
      "Complete Bone Voyage and reach 5 Hunter and 5 Crafting to repeat birdhouse runs for nests, seeds, and Hunter experience. The group also needs reusable clockworks.",
    scope: "character",
    category: "Hunter",
    repeatable: true,
    validator: every(quest(11, "Bone Voyage"), skill("Hunter", 5), skill("Crafting", 5)),
    metadata: { wikiUrl: `${WIKI}Bird_house_trapping` },
  },
  {
    ...
    type: "activity",
    description:
      "Reach 45 Farming to complete easy contracts for seed packs, including a repeatable source of herb seeds.",
    scope: "character",
  ...
  },
  {
    ...
    title: "Ranarr herb runs",
    type: "activity",
    description: "Reach 32 Farming to repeat herb runs with ranarr seeds for prayer potion supplies.",
    scope: "character",
    category: "Prayer Potions",
    repeatable: true,
